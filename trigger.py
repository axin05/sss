...
content = [{
    "content": "在竞争激烈的A+级市场，奇瑞艾瑞泽8凭借**越级产品力**成功突围。鲲鹏动力1.6T发动机爆发出**197匹马力**，匹配7速湿式双离合，动力响应迅猛；**2790mm超长轴距**带来行政级后排空间，全车80%软包材质+索尼音响提升豪华质感。智能方面，24.6吋双联屏支持AI语音交互，L2.5级驾驶辅助含自动泊车、全速域ACC，新手也能轻松驾驭。更难得的是，**28项NVH静音技术**让高速巡航低声噪媲美B级车，而运动底盘调校则兼顾舒适与操控乐趣。从颜值到内核，艾瑞泽8完美诠释了「鱼和熊掌兼得」\n\n——10万级预算，30万级体验！",
    "title": "「艾瑞泽8：10万级家轿的“六边形战士”，年轻人的第一台性能家轿！」"
}, {
    "content": "【10万级家轿卷王！奇瑞艾瑞泽8真香警告】🔥  \n\n✨ 1.6T爆197马力，7秒级破百！同级最强鲲鹏动力，油耗仅6.5L！  \n✨ 近4.8米车长+2.79米轴距，后排能跷二郎腿，B级空间A级价！  \n✨ 双12.3寸曲面屏+索尼8音响，L2.5级智驾全系标配！  \n💥 终身质保+终身免流量，11.99万起售，合资车看完直哆嗦！  \n\n#奇瑞艾瑞泽8 #十万级家轿天花板  \n👉 试过才知道：10万预算买30万享受！\n",
...
def postPagerWithVideo(video, cover):
    try:
        ...
        data = {
            "contentType": "3",
            "title": content[random.randint(0, 1)]['title'],
            "detail": "{}{}".format(content[random.randint(0, 1)]['content'],
                                    uuid.uuid4()),
